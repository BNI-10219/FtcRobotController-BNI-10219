...
@Disabled
@Autonomous(name = "Red Basic Launch Park Backstage", group = "Red")
public class RedBasicLaunchParkBackstage extends AutoMainProgram {

    Follower follower;

    private PathState pathState = PathState.READY;

//    private final Pose startPose = new Pose(128, 32, Math.toDegrees(135));
//    private final Pose launch = new Pose(84, 60, Math.toDegrees(135));
//    private final Pose park = new Pose(36, 36, Math.toDegrees(-90));

    private final Pose startPose = new Pose(120, 132, Math.toRadians(225));
