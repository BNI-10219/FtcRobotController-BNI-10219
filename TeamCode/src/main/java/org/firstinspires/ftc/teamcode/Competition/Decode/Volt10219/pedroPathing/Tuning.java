...
import static org.firstinspires.ftc.teamcode.Competition.Decode.Volt10219.pedroPathing.Tuning.changes;
import static org.firstinspires.ftc.teamcode.Competition.Decode.Volt10219.pedroPathing.Tuning.drawOnlyCurrent;
import static org.firstinspires.ftc.teamcode.Competition.Decode.Volt10219.pedroPathing.Tuning.draw;
import static org.firstinspires.ftc.teamcode.Competition.Decode.Volt10219.pedroPathing.Tuning.follower;
import static org.firstinspires.ftc.teamcode.Competition.Decode.Volt10219.pedroPathing.Tuning.stopRobot;
import static org.firstinspires.ftc.teamcode.Competition.Decode.Volt10219.pedroPathing.Tuning.telemetryM;
...
class ForwardVelocityTuner extends OpMode {
    ...
    public void loop() {
        ...
        // Show pose every loop so you can see it moving
        telemetryM.debug("pose", follower.getPose());
        ...
        if (!end) {
            ...
            stopRobot();
            double average = 0;
            for (double v : velocities) average += v;
