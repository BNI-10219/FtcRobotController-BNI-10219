...
import org.firstinspires.ftc.teamcode.Competition.Decode.Volt10219.Controls.Auto.Blue.Paths.Audience.BlueLaunchParkAudienceCamDuValV3;
...
@Autonomous(name = "Blue Backstage - Cam, Complex, TEST")
public class BlueLaunchParkBackstageCamDuValV3 extends BlueAlliance {
    ...
    double launchRollerStopTimer_ONE = 2.0;
    double launchRollerTimeEngaged_TWO = 0.5;
    double launchRollerStopTimer_TWO = 2.0;
    double launchRollerTimeEngaged_THREE = 0.5;
    ...
    public void automaticLaunch() {
        switch(launchState) {
            ...
            case READY:
//                Bot.ballLaunchAutoVelocity(launch_power);
                //outtakeTimer.resetTimer();
                intakeTimer.resetTimer();
                break;
            ...
            case OUTTAKE:
                ...
                switch (launchNumber) {
                    case PREP:
                        ...
                        // MAKES SURE TIME IS RESET ONLY ONCE WHEN FIRST CALLED
                        if (!timerReset) {
                            outtakeTimer.resetTimer();
                            timerReset = true;
                        }

                        if (outtakeTimer.getElapsedTimeSeconds() >= waitToStartTimer) {
                            launchNumber = LaunchNumber.FIRST_ROLLER_START;
                            outtakeTimer.resetTimer();
                        }
                        break;
                    ...
                    case FIRST_ROLLER_START:
                        ...
                        if (outtakeTimer.getElapsedTimeSeconds() >= launchRollerTimeEngaged_ONE) {
                    ...
                    case FIRST_ROLLER_STOP:
                        ...
                        if (outtakeTimer.getElapsedTimeSeconds() >= launchRollerStopTimer_ONE) {
                            launchNumber = LaunchNumber.SECOND_ROLLER_START;
                            outtakeTimer.resetTimer();
                        }
                    ...
                    case SECOND_ROLLER_START:
                        ...
                        if (outtakeTimer.getElapsedTimeSeconds() >= launchRollerTimeEngaged_TWO) {
                            launchNumber = LaunchNumber.SECOND_ROLLER_STOP;
                            outtakeTimer.resetTimer();
                        }
                    ...
                    case SECOND_ROLLER_STOP:
                        ...
                        if (outtakeTimer.getElapsedTimeSeconds() >= launchRollerStopTimer_TWO) {
                            launchNumber = LaunchNumber.THIRD_ROLLER_START;
                            outtakeTimer.resetTimer();
                        }
                    ...
                    case THIRD_ROLLER_START:
                        ...
                        if (outtakeTimer.getElapsedTimeSeconds() >= launchRollerTimeEngaged_THREE) {
                            launchNumber = LaunchNumber.THIRD_ROLLER_STOP;
                            outtakeTimer.resetTimer();
                        }
                    ...
                    case THIRD_ROLLER_STOP:
                        ...
                        if (outtakeTimer.getElapsedTimeSeconds() >= launchRollerStopTimer_THREE) {
                            launchNumber = LaunchNumber.STOP_LAUNCHING;
                            // USE THIS IS NOT GETTING ALL 3 LAUNCHED.  AND THEN MOVE ABOVE LINE TO case FAILSAFE_ROLLER_STOP:
                            // launchNumber = LaunchNumber.FAILSAFE_ROLLER_START;
                            outtakeTimer.resetTimer();
                        }
                    ...
                    case FAILSAFE_ROLLER_START:
                        ...
                        if (outtakeTimer.getElapsedTimeSeconds() >= launchRollerTimeEngaged_FAILSAFE) {
                            launchNumber = LaunchNumber.FAILSAFE_ROLLER_STOP;
                            outtakeTimer.resetTimer();
                        }
                    ...
                    case FAILSAFE_ROLLER_STOP:
                        ...
                        if (outtakeTimer.getElapsedTimeSeconds() >= launchRollerStopTimer_FAILSAFE) {
                            launchNumber = LaunchNumber.STOP_LAUNCHING;
                            outtakeTimer.resetTimer();
                        }
                        break;
